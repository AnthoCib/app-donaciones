...
(1, 'PUB-0001', 2, 2, 'Pan francés', 'Pan elaborado durante la mañana y en buen estado.', 50, 'UNIDAD', DATE_ADD(CURRENT_TIMESTAMP, INTERVAL 1 DAY), 'https://ejemplo.com/pan.jpg', 'Ventanilla', 'Av. Principal 100', -11.8765000, -77.1278000, 'PUBLICADA', CURRENT_TIMESTAMP, 1);
