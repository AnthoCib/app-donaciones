...
public record PublicacionRequest(@NotNull Long idCategoria, @NotBlank String nombreAlimento, String descripcion,
		@NotNull @DecimalMin("0.01") BigDecimal cantidadDisponible, @NotNull UnidadMedida unidadMedida, @NotNull @Future LocalDateTime fechaVencimiento, String imagenUrl,
